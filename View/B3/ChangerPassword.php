...
<body>
    ...
    <div class="block">
        ...
        <div class="right">
            ...
            <form class="formulaire" id="formulaire-change-password" novalidate>
                ...
                <div class="champs-normal">
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="password" id="new_password" name="new_password" autocomplete="off" class="input-custom" minlength="8" placeholder=" " required>
                        <label class="user-label-custom" for="new_password">Nouveau mot de passe<span class="required-asterisk">*</span></label>
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="password" id="mdp_confirm_utilisateur" name="mdp_confirm_utilisateur" autocomplete="off" class="input-custom" minlength="8" placeholder=" " required>
                        <label class="user-label-custom" for="mdp_confirm_utilisateur">Confirmer nouveau mot de passe<span class="required-asterisk">*</span></label>
