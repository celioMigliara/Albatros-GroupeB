        ...
        <?php foreach ($utilisateurs as $u): ?>
          <tr>
            ...
            <td>
              ...
              <a href="<?= BASE_URL ?>/utilisateurs/modifier/<?= $u['user_id'] ?>" class="btn btn-primary">Modifier</a>

              <?php if ($u['actif']): ?>
                <?php if ($u['user_id'] != $_SESSION['user']['id']): ?>
                  <a href="<?= BASE_URL ?>/utilisateurs/desactiver/<?= $u['user_id'] ?>" class="btn btn-warning"
                    data-userid="<?= $u['user_id'] ?>">Désactiver</a>
                <?php else: ?>
                  <span class="btn btn-secondary disabled">Désactiver</span>
                <?php endif; ?>
              <?php else: ?>
                <a href="<?= BASE_URL ?>/utilisateurs/activer/<?= $u['user_id'] ?>" class="btn btn-success"
                  data-userid="<?= $u['user_id'] ?>">Activer</a>
              <?php endif; ?>
            </td>
          </tr>
        <?php endforeach; ?>
