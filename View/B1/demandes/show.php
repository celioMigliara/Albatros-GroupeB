...
<?php require_once __DIR__ . '/../../B5/navbarAdmin.php'; ?>
    ...
    <div class="demande-card">
        ...
        <form method="POST" action="index.php?action=updateDemande" enctype="multipart/form-data">
        ...
        <?php if ($_SESSION['user_role'] == 1): ?>
            <div class="admin-comment">
                <form method="POST" action="index.php?action=updateCommentaire">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($demande['id_demande']) ?>">
...
<?php if ($_SESSION['user_role'] == 1): ?>
    <div class="buttons">
        <?php if ($isDemandeModifiable): ?>
            <form method="POST" action="index.php?action=refuserDemande&id=<?= htmlspecialchars($demande['id_demande']) ?>">
            <button type="submit" class="btn btn-danger">Refuser demande</button>
            </form>
            <button class="btn btn-success">Terminer demande</button>
